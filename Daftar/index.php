...
if ($slide == "0") {
?>
  <div id="gantiSlide" class="bg pt-5 pb-5" style="background-image: url(../assets/img/akademik_slide.jpg); background-size: cover; background-position: center center; height: 100%;">
  <?php } ?>
  <?php
  if ($slide == "1") {
  ?>
    <div id="gantiSlide" class="bg pt-5 pb-5" style="background-image: url(../assets/img/nonakademik_slide.jpg); background-size: cover; background-position: center center; height: 100%;">
    <?php } ?>
    <?php
    if ($slide == "2") {
    ?>
      <div id="gantiSlide" class="bg pt-5 pb-5" style="background-image: url(../assets/img/penelitian_slide.jpg); background-size: cover; background-position: center center; height: 100%;">
      <?php } ?>
      <div id="slideSlide">
        <div class="overlay"></div>
        <div class="container">
          <div class="card shadow mb-4 col-xl-6 col-lg-6 col-md-10  mx-auto opacity-saya">
            <div class="card-header d-sm-flex align-items-center justify-content-center mb-3 utama shadow">
              <h1 class="h4 mb-0 text-utama font-weight-bolder text-white">ISI DATA DIRI</h1>
            </div>
            <div class="card-body">
              <?php
                  ...
                  if (isset($_POST['nilai_IPK'])) {
                    if ($_POST['nilai_IPK'] >= 3) { ?>
                      <select class="form-select" aria-label="Default select example" name="pilihan" id="pilihan">
                        ...
                        if ($slide == "0") {
                        ?>
                          <option onclick="" selected value="Beasiswa Akademik">Beasiswa Akademik</option>
                          <option onclick="" value="Beasiswa Non Akademik">Beasiswa Non Akademik</option>
                          <option onclick="" value="Beasiswa Penelitian">Beasiswa Penelitian</option>
                        <?php } ?>
                        <?php
                        if ($slide == "1") {
                        ?>
